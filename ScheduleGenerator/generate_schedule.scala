...
      this.level += 1;
      emitString = emitString +
        this.emitNodeAttributeOptional(x, List(("Identifier", this.k)), true) +
        this.emitNodeAttributesRequired(x, List(("TableName", this.s))) +
        this.emit(f"{ // SystemError\n");
      this.level += 1;
...
    case "0" => "ERROR_CODE_TYPE::DEADLINE_MISSED"
    case "1" => "ERROR_CODE_TYPE::APPLICATION_ERROR"
    case "2" => "ERROR_CODE_TYPE::NUMERIC_ERROR"
    case "3" => "ERROR_CODE_TYPE::ILLEGAL_REQUEST"
    case "4" => "ERROR_CODE_TYPE::STACK_OVERFLOW"
    case "5" => "ERROR_CODE_TYPE::MEMORY_VIOLATION"
    case "6" => "ERROR_CODE_TYPE::HARDWARE_FAULT"
    case "7" => "ERROR_CODE_TYPE::POWER_FAILURE"
